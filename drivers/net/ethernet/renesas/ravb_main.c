...
static const struct of_device_id ravb_match_table[] = {
	...
	{ .compatible = "renesas,etheravb-r8a7796", .data = &ravb_gen3_hw_info },
	{ .compatible = "renesas,etheravb-r8a77961", .data = &ravb_gen3_hw_info },
