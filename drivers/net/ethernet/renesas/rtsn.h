...
#define AXIWC_DEFAULT		0x000fffff
#define AXIRC_DEFAULT		0x000fffff
#define TDPC0_DEFAULT		0x76543210

#define TSA(n)			(TSA0 + (n) * 0x08)
#define TSS(n)			(TSS0 + (n) * 0x08)
