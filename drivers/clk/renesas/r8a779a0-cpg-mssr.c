...
static const struct cpg_core_clk r8a779a0_core_clks[] __initconst = {
	...
	DEF_BASE("rpc",			R8A779A0_CLK_RPC, CLK_TYPE_GEN3_RPC, CLK_RPCSRC),
	DEF_BASE("rpcd2",		R8A779A0_CLK_RPCD2, CLK_TYPE_GEN3_RPCD2, R8A779A0_CLK_RPC),

	/* Core Clock Outputs */
	DEF_GEN3_Z("z0",	R8A779A0_CLK_Z0,	CLK_TYPE_GEN3_Z, CLK_PLL20_DIV2,  1, 1),
	DEF_GEN3_Z("z1",	R8A779A0_CLK_Z1,	CLK_TYPE_GEN3_Z, CLK_PLL21_DIV2,  1, 1),
