...
static const struct mssr_mod_clk r8a779a0_mod_clks[] __initconst = {
	...
	DEF_MOD("du0",				 411,	R8A779A0_CLK_S2D1), /* Base on V3H - No information in V3U */
	DEF_MOD("ipmmuvi0",			 412,	R8A779A0_CLK_S1D1),
	DEF_MOD("ipmmuvi1",			 413,	R8A779A0_CLK_S1D1), /* No information, temporary clock source basse on TS, */
	DEF_MOD("dsi0",				 415,	R8A779A0_CLK_DSI),
	DEF_MOD("dsi1",				 416,	R8A779A0_CLK_DSI),
//	DEF_MOD("fcpcs",			 507,	R8A779A0_CLK_), /* No information */
	DEF_MOD("fcpvd0",			 508,	R8A779A0_CLK_S3D1), /* Base on V3H - No information in V3U */
	DEF_MOD("fcpvd1",			 509,	R8A779A0_CLK_S3D1), /* Base on V3H - No information in V3U */
	...
	DEF_MOD("ispcs0",			 612,	R8A779A0_CLK_S1D1), /* No information */
	DEF_MOD("ispcs1",			 613,	R8A779A0_CLK_S1D1), /* No information */
	DEF_MOD("ispcs2",			 614,	R8A779A0_CLK_S1D1), /* No information */
	DEF_MOD("ispcs3",			 615,	R8A779A0_CLK_S1D1), /* No information */
...
//	DEF_MOD("vcp4l",			 729,	R8A779A0_CLK_), /* No information, old name is VCPL4 ? */
	DEF_MOD("vin0",				 730,	R8A779A0_CLK_S1D1), /* There are 9 vin1, */
	DEF_MOD("vin1",				 731,	R8A779A0_CLK_S1D1), /* and 7 vin0 ? */
	...
	DEF_MOD("vspd0",			 830,	R8A779A0_CLK_S3D1), /* Base on V3H - No information in V3U */
	DEF_MOD("vspd1",			 831,	R8A779A0_CLK_S3D1), /* Base on V3H - No information in V3U */
	...
	DEF_MOD("pfc0",				 915,	R8A779A0_CLK_CP), /* Base on V3H - No information in V3U */
	DEF_MOD("pfc1",				 916,	R8A779A0_CLK_CP), /* Base on V3H - No information in V3U */
	DEF_MOD("pfc2",				 917,	R8A779A0_CLK_CP), /* Base on V3H - No information in V3U */
	DEF_MOD("pfc3",				 918,	R8A779A0_CLK_CP), /* Base on V3H - No information in V3U */
//	DEF_MOD("vspx0",			 1028,	R8A779A0_CLK_), /* No information */
//	DEF_MOD("vspx1",			 1029,	R8A779A0_CLK_), /* No information */
//	DEF_MOD("vspx2",			 1030,	R8A779A0_CLK_), /* No information */
//	DEF_MOD("vspx3",			 1031,	R8A779A0_CLK_), /* No information */
//	DEF_MOD("fcpvx0",			 1100,	R8A779A0_CLK_), /* No information */
//	DEF_MOD("fcpvx1",			 1101,	R8A779A0_CLK_), /* No information */
//	DEF_MOD("fcpvx2",			 1102,	R8A779A0_CLK_), /* No information */
//	DEF_MOD("fcpvx3",			 1103,	R8A779A0_CLK_), /* No information */
};
