...
static const struct cpg_core_clk r8a779a0_core_clks[] __initconst = {
	...
	DEF_FIXED("dsiref",	R8A779A0_CLK_DSIREF,	CLK_PLL5_DIV4,	48, 1),
	...
	DEF_DIV6P1("dsiext",	R8A779A0_CLK_DSIEXT,	CLK_PLL5_DIV4,	0x0884),
...
static const struct mssr_mod_clk r8a779a0_mod_clks[] __initconst = {
	...
	DEF_MOD("du0",		411,	R8A779A0_CLK_DSIREF),
	DEF_MOD("ipmmuvi0",	412,	R8A779A0_CLK_S1D1),
	DEF_MOD("ipmmuvi1",	413,	R8A779A0_CLK_S1D1),
	DEF_MOD("dsi0",		415,	R8A779A0_CLK_DSIREF),
	DEF_MOD("dsi1",		416,	R8A779A0_CLK_DSIREF),
