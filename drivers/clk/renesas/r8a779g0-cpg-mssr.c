...
static const struct cpg_core_clk r8a779g0_core_clks[] __initconst = {
	...
	DEF_FIXED("sasyncperd1", R8A779G0_CLK_SASYNCPERD1, CLK_PLL5_DIV4, 1, 1),
	DEF_FIXED("sasyncperd2", R8A779G0_CLK_SASYNCPERD2, CLK_PLL5_DIV4, 2, 1),
	DEF_FIXED("sasyncperd4", R8A779G0_CLK_SASYNCPERD4, CLK_PLL5_DIV4, 4, 1),
	DEF_FIXED("cpex",	R8A779G0_CLK_CPEX,	CLK_EXTAL,	2, 1),
...
static const struct mssr_mod_clk r8a779g0_mod_clks[] __initconst = {
	DEF_MOD("rgx",			0,	R8A779G0_CLK_S0D3),
	...
	DEF_MOD("canfd",		328,	R8A779G0_CLK_S0D3),
	...
	DEF_MOD("ddr1:ddr0",		409,	R8A779G0_CLK_S0D3),
	DEF_MOD("ddr3:ddr2",		410,	R8A779G0_CLK_S0D3),
	DEF_MOD("dis0",			411,	R8A779G0_CLK_S0D3),
	DEF_MOD("doc2ch",		414,	R8A779G0_CLK_S0D3),
	DEF_MOD("dsitxlink0",		415,	R8A779G0_CLK_S0D3),
	DEF_MOD("dsitxlink1",		416,	R8A779G0_CLK_S0D3),
	...
	DEF_MOD("intap",		531,	R8A779G0_CLK_S0D6_PER),

	DEF_MOD("ipc",			601,	R8A779G0_CLK_MSO),
	DEF_MOD("inttp",		608,	R8A779G0_CLK_MSO),
	DEF_MOD("irqc",			611,	R8A779G0_CLK_MSO),
	...
	DEF_MOD("sysrom",		707,	R8A779G0_CLK_SD0),
	...
	DEF_MOD("vin00",		730,	R8A779G0_CLK_S0D1_VIO),
	DEF_MOD("vin01",		730,	R8A779G0_CLK_S0D1_VIO),
