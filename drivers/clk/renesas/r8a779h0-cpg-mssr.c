...
static const struct cpg_core_clk r8a779h0_core_clks[] = {
	...
	DEF_FIXED("cl16m_hsc",	R8A779H0_CLK_CL16M_HSC,	CLK_S0_HSC,	48, 1),
        DEF_DIV6P1("post",      R8A779H0_CLK_POST,      CLK_PLL5_DIV4,  0x890),
        DEF_DIV6P1("post2",     R8A779H0_CLK_POST2,     CLK_PLL5_DIV4,  0x0894),
        DEF_DIV6P1("post3",     R8A779H0_CLK_POST3,     CLK_PLL5_DIV4,  0x898),
        DEF_DIV6P1("post4",     R8A779H0_CLK_POST4,     CLK_PLL5_DIV4,  0x089C),
...
static const struct mssr_mod_clk r8a779h0_mod_clks[] = {
	DEF_MOD("rgx",			0,	R8A779H0_CLK_ZG),
	DEF_MOD("smpo0",		5,	R8A779H0_CLK_S0D3),
	DEF_MOD("smps0",		7,	R8A779H0_CLK_S0D3),
	DEF_MOD("umfl0",		9,	R8A779H0_CLK_S0D3),
	DEF_MOD("isp0",			16,	R8A779H0_CLK_S0D1_VIO),
	DEF_MOD("impcnn",		22,	R8A779H0_CLK_S0D6_PER),
	DEF_MOD("spmc",			23,	R8A779H0_CLK_S0D6_PER),
	DEF_MOD("imp0",			24,	R8A779H0_CLK_S0D6_PER),
	DEF_MOD("imp1",			25,	R8A779H0_CLK_S0D6_PER),
	DEF_MOD("impdmac0",		26,	R8A779H0_CLK_MSO),
	DEF_MOD("imppsc",		27,	R8A779H0_CLK_MSO),
	DEF_MOD("impdmac1",		105,	R8A779H0_CLK_S0D3),
	DEF_MOD("impdta",		116,	R8A779H0_CLK_S0D3),
	DEF_MOD("impslv",		118,	R8A779H0_CLK_S0D6_PER),
	DEF_MOD("spmi",			120,	R8A779H0_CLK_S0D6_PER),
	...
	DEF_MOD("imr0",		525,	R8A779H0_CLK_S0D6_PER),
	DEF_MOD("imr1",		526,	R8A779H0_CLK_S0D6_PER),
	DEF_MOD("ims0",		529,	R8A779H0_CLK_S0D6_PER),
	DEF_MOD("ims1",		530,	R8A779H0_CLK_S0D6_PER),
	DEF_MOD("irqc",		611,	R8A779H0_CLK_CL16M),
	DEF_MOD("ispcs0",	612,	R8A779H0_CLK_S0D2_VIO),
	DEF_MOD("ispcs1",	613,	R8A779H0_CLK_S0D2_VIO),
	DEF_MOD("ivcp1e",	616,	R8A779H0_CLK_MSO),
	...
	DEF_MOD("pcie0",        624,    R8A779H0_CLK_S0D2),
	DEF_MOD("pwm",		628,	R8A779H0_CLK_SASYNCPERD4),
	DEF_MOD("rpc-if",	629,	R8A779H0_CLK_RPCD2),
	DEF_MOD("rtdm0",	630,	R8A779H0_CLK_S0D4_RT),
	DEF_MOD("rtdm1",	631,	R8A779H0_CLK_S0D4_RT),
	...
	DEF_MOD("caiplite_wrapper0",	720,	R8A779H0_CLK_S0D2),
	DEF_MOD("caiplite0",			721,	R8A779H0_CLK_S0D1_VIO),
	DEF_MOD("caiplite1",			722,	R8A779H0_CLK_S0D1_VIO),
	DEF_MOD("caiplite2",			723,	R8A779H0_CLK_S0D1_VIO),
	DEF_MOD("caiplite3",			724,	R8A779H0_CLK_S0D1_VIO),
	DEF_MOD("caiplite4",			725,	R8A779H0_CLK_S0D1_VIO),
	DEF_MOD("caiplite5",			726,	R8A779H0_CLK_S0D1_VIO),
	DEF_MOD("caiplite6",			727,	R8A779H0_CLK_S0D1_VIO),
	DEF_MOD("caiplite7",			728,	R8A779H0_CLK_S0D1_VIO),
	...
	DEF_MOD("wcrc2",	905,	R8A779H0_CLK_S0D2_RT),
	DEF_MOD("wcrc3",	906,	R8A779H0_CLK_S0D2_RT),
	...
	DEF_MOD("fcpvx0",	1100,	R8A779H0_CLK_S0D2_VC),

	DEF_MOD("cve0",		2706,	R8A779H0_CLK_SVD1_IR),
	DEF_MOD("cve1",		2707,	R8A779H0_CLK_SVD1_IR),
	...
	DEF_MOD("paptop",		2806,	R8A779H0_CLK_S0D6_PER),
	DEF_MOD("papsdma",		2807,	R8A779H0_CLK_S0D6_PER),
	DEF_MOD("vdsp0_csb",	2821,	R8A779H0_CLK_SVD1_IR),
	DEF_MOD("vdsp1_csb",	2830,	R8A779H0_CLK_SVD1_IR),
