...
static const struct soc_device_attribute r8a7795es10_11[] __initconst = {
	{ .soc_id = "r8a7795", .revision = "ES1.[01]" },
	{ /* sentinel */ }
};

static const struct soc_device_attribute r8a7796es10[] __initconst = {
	...
	struct clk **clks, void __iomem *base)
{
	...
	case CLK_TYPE_GEN3_R:
		if (soc_device_match(r8a7795es10_11) ||
