...
#define VCLKSET_DIV_1		(0 << 4)
#define VCLKSET_DIV_2		(1 << 4)
#define VCLKSET_DIV_4		(2 << 4)
#define VCLKSET_DIV_8		(3 << 4)
#define VCLKSET_BPP_16		(0 << 2)
#define VCLKSET_BPP_18		(1 << 2)
#define VCLKSET_BPP_18L		(2 << 2)
#define VCLKSET_BPP_24		(3 << 2)
#define VCLKSET_1_LANE		(0 << 0)
#define VCLKSET_2_LANE		(1 << 0)
#define VCLKSET_3_LANE		(2 << 0)
#define VCLKSET_4_LANE		(3 << 0)
