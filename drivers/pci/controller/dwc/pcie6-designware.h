...
struct dw_pcie6_host_ops {
	int (*init)(struct dw_pcie6_rp *pp);
	void (*deinit)(struct dw_pcie6_rp *pp);
	void (*post_init)(struct dw_pcie6_rp *pp);
	int (*msi_init)(struct dw_pcie6_rp *pp);
	void (*pme_turn_off)(struct dw_pcie6_rp *pp);
};
...
struct dw_pcie6_ep_ops {
	void	(*pre_init)(struct dw_pcie6_ep *ep);
	void	(*init)(struct dw_pcie6_ep *ep);
	 ...
	 * driver.
	 */
	unsigned int (*get_dbi_offset)(struct dw_pcie6_ep *ep, u8 func_no);
	unsigned int (*get_dbi2_offset)(struct dw_pcie6_ep *ep, u8 func_no);
};
...
static inline unsigned int dw_pcie6_ep_get_dbi_offset(struct dw_pcie6_ep *ep,
						     u8 func_no)
{
...
static inline u32 dw_pcie6_ep_read_dbi(struct dw_pcie6_ep *ep, u8 func_no,
				      u32 reg, size_t size)
{
	unsigned int offset = dw_pcie6_ep_get_dbi_offset(ep, func_no);
	struct dw_pcie6 *pci = to_dw_pcie6_from_ep(ep);

	return dw_pcie6_read_dbi(pci, offset + reg, size);
}

static inline void dw_pcie6_ep_write_dbi(struct dw_pcie6_ep *ep, u8 func_no,
					u32 reg, size_t size, u32 val)
{
	unsigned int offset = dw_pcie6_ep_get_dbi_offset(ep, func_no);
	struct dw_pcie6 *pci = to_dw_pcie6_from_ep(ep);

	dw_pcie6_write_dbi(pci, offset + reg, size, val);
}

static inline void dw_pcie6_ep_writel_dbi(struct dw_pcie6_ep *ep, u8 func_no,
					 u32 reg, u32 val)
{
	dw_pcie6_ep_write_dbi(ep, func_no, reg, 0x4, val);
}

static inline u32 dw_pcie6_ep_readl_dbi(struct dw_pcie6_ep *ep, u8 func_no,
				       u32 reg)
{
	return dw_pcie6_ep_read_dbi(ep, func_no, reg, 0x4);
}

static inline void dw_pcie6_ep_writew_dbi(struct dw_pcie6_ep *ep, u8 func_no,
					 u32 reg, u16 val)
{
	dw_pcie6_ep_write_dbi(ep, func_no, reg, 0x2, val);
}

static inline u16 dw_pcie6_ep_readw_dbi(struct dw_pcie6_ep *ep, u8 func_no,
				       u32 reg)
{
	return dw_pcie6_ep_read_dbi(ep, func_no, reg, 0x2);
}

static inline void dw_pcie6_ep_writeb_dbi(struct dw_pcie6_ep *ep, u8 func_no,
					 u32 reg, u8 val)
{
	dw_pcie6_ep_write_dbi(ep, func_no, reg, 0x1, val);
}

static inline u8 dw_pcie6_ep_readb_dbi(struct dw_pcie6_ep *ep, u8 func_no,
				      u32 reg)
{
	return dw_pcie6_ep_read_dbi(ep, func_no, reg, 0x1);
}

static inline unsigned int dw_pcie6_ep_get_dbi2_offset(struct dw_pcie6_ep *ep,
						      u8 func_no)
{
...
static inline void dw_pcie6_ep_write_dbi2(struct dw_pcie6_ep *ep, u8 func_no,
					 u32 reg, size_t size, u32 val)
{
	unsigned int offset = dw_pcie6_ep_get_dbi2_offset(ep, func_no);
	struct dw_pcie6 *pci = to_dw_pcie6_from_ep(ep);

	dw_pcie6_write_dbi2(pci, offset + reg, size, val);
}

static inline void dw_pcie6_ep_writel_dbi2(struct dw_pcie6_ep *ep, u8 func_no,
					  u32 reg, u32 val)
{
	dw_pcie6_ep_write_dbi2(ep, func_no, reg, 0x4, val);
}
...
static inline enum dw_pcie6_ltssm dw_pcie6_get_ltssm(struct dw_pcie6 *pci)
{
	u32 val;
	...
	val = dw_pcie6_readl_dbi(pci, PCIE_PORT_DEBUG0);

	return (enum dw_pcie6_ltssm)FIELD_GET(PORT_LOGIC_LTSSM_STATE_MASK, val);
}
...
void __iomem *dw_pcie6_own_conf_map_bus(struct pci_bus *bus, unsigned int devfn,
				       int where);
#else
static inline irqreturn_t dw_pcie6_handle_msi_irq(struct dw_pcie6_rp *pp)
{
	return IRQ_NONE;
}

static inline int dw_pcie6_setup_rc(struct dw_pcie6_rp *pp)
{
	return 0;
}

static inline int dw_pcie6_host_init(struct dw_pcie6_rp *pp)
{
	return 0;
}

static inline void dw_pcie6_host_deinit(struct dw_pcie6_rp *pp)
{
}

static inline int dw_pcie6_allocate_domains(struct dw_pcie6_rp *pp)
{
	return 0;
}
...
static inline void dw_pcie6_ep_linkdown(struct dw_pcie6_ep *ep)
{
}
...
static inline int dw_pcie6_ep_init_registers(struct dw_pcie6_ep *ep)
{
	return 0;
}

static inline void dw_pcie6_ep_deinit(struct dw_pcie6_ep *ep)
{
}

static inline void dw_pcie6_ep_cleanup(struct dw_pcie6_ep *ep)
{
}

static inline int dw_pcie6_ep_raise_intx_irq(struct dw_pcie6_ep *ep, u8 func_no)
{
	return 0;
}
