...
void rcar_gen5_pcie_set_max_link_width(struct rcar_pcie4 *rcar_pcie4, int num_lanes)
{
...
int rcar_gen5_pcie_set_device_type(struct rcar_pcie4 *rcar_pcie4, bool rc)
{
	u32 val;
...
int rcar_gen5_pcie_devm_reset_get(struct rcar_pcie4 *rcar_pcie4,
				  struct device *dev)
{
	rcar_pcie4->perst = devm_reset_control_get(dev, NULL);
