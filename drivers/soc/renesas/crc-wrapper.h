 ...
 * @start_e2e_crc:	The routine for starting E2E CRC mode.
 * @set_e2e_crc:	The routine for setting Data Through mode.
 * @start_e2e_crc:	The routine for starting Data Through mode.
 * @set_e2e_data_thr:	The routine for setting E2E Data Through mode.
 * @start_e2e_data_thr:	The routine for starting E2E Data Through mode.
 *
